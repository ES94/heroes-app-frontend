...
describe("HeroStats", () => {
  ...
  test("should render stats with mock information", () => {
  ...
  test("should hange the percentage of favorites when a hero is added to favorites", () => {
    ...
    expect(favoritePercentageElement.innerHTML).toContain("4% del total");
